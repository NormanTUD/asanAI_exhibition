<div>
	<div class="general">
		...
		<div style="display: none" class="tab startpage_tab" id="neural_network_explanation_tab">
			<div class="halftext">
		...
		<div style="display: none" class="tab startpage_tab" id="layer_explanation_tab">
			<div class="halftext">
		...
		<div style="display: none"  class="tab startpage_tab" id="forward_propagation_explanation_tab">
			<div class="halftext">
		...
		<div style="display: none" class="tab startpage_tab" id="training_explanation_tab">
			<div class="halftext">
