...
?>
		...
		<div class="container">
			<button id="box1" class="box inverted" onclick="location.href='11_test_images.php'">
				<span class="TRANSLATEME_fruit"></span>
			</button>
			<button id="box2" class="box inverted" onclick="location.href='12_option2.php'">
				<span class="TRANSLATEME_everyday_objects"></span>
			</button>
			<button id="box3" class="box inverted" onclick="location.href='30_train.php'">
